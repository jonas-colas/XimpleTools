...
class ResultCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings(__('base.result'), __('base.results'));
    }
    ...
    protected function setupShowOperation()
    {
        ...
        CRUD::setShowContentClass('col-md-12 bold-labels');
        CRUD::setShowView('vendor.backpack.crud.result_show');
